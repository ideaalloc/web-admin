package com.microentropy.admin.constants;
...
public final class MimeTypeConstants {
     ...
     * Default Mime type
     */
    static final String s_strDefaultMimeType = "application/octet-stream";
    ...
    public static String getMimeType(String strKey) {
        final String strMimeType = s_mapMimeTypes.get(strKey);
